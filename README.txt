...
![image alt](https://github.com/sametcorekci/BlogSite-Sprigboot-RESTAPI_v2/blob/5c8a5608385cc3afa27e3c52c7c0b45faa3b729d/springboot.png)
...
- Version 2 ' Versiyon 1'de Spring ve Spring Boot frameworklerin neden var olduğu, nasıl işimizi kolaylaştırdığı ve Spring Boot' un mantığını daha iyi anlayabilmek için JPA ve Hibernate hayatımızda yokmuş gibi davrandık. Bu versiyonda Jpa ve Hibarnete teknolojileri kullanılarak devam edildi. Şüphesiz daha iyi versiyonları geliştirilebilir. Unutulmamalıdır ki bu sadece bir "DEMO" niteliği taşımaktadır.  

- Versionlar şeklinde proje takip edildiğinde projeler arasındaki farklar daha iyi anlaşılacaktır. İşlemlerimizi ilk etapta manuel bir şekilde işleyecek
  şekilde tasarlanmıştı. Şimdi ise var olan teknolojileri kullanma yolu izlemiştir. Kullanılan teknolojiler ve araçlar ;
